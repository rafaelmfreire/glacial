      ...
      <nav class="bg-white border-b border-gray-100">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="shrink-0 flex items-center">
                <Link :href="route('air_conditioners.index')">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <JetNavLink :href="route('requisitions.index')" :active="route().current('requisitions.index')"> Requisições </JetNavLink>
                ...
                <JetDropdown align="right" width="48">
                  <template #trigger>
                    ...
                    <span v-else class="inline-flex rounded-md">
                      <button type="button" class="inline-flex items-center px-3 py-2 border border-gray-100 text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 hover:bg-gray-50 focus:outline-none transition">
        ...
        >
          <div class="pt-2 pb-3 space-y-1">
            ...
            <JetResponsiveNavLink :href="route('requisitions.index')" :active="route().current('requisitions.index')">Requisições</JetResponsiveNavLink>
          </div>
