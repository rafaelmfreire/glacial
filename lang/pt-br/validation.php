...
return [
    ...
    */
    ...
    'enum' => 'O valor informado de :attribute é inválido.',
    ...
    */
    ...
    'attributes' => [
        'quote_number' => 'nº do orçamento',
        'number' => 'número',
        'year' => 'ano',
        'contract_item_id' => 'item do contrato',
        'quantity' => 'quantidade',
        'date' => 'data',
        'service_date' => 'data do serviço',
        'services' => 'serviços',
        'technicians' => 'equipe',
        'done_at' => 'data de realização',
        'problem' => 'problema',
        'informed_by' => 'informante',
        'opened_at' => 'data de abertura',
        'room' => 'sala',
        'brand' => 'marca',
        'identifier' => 'tombamento',
        'contract_item_value' => 'valor do item do contrato',
        'title' => 'título',
    ],
